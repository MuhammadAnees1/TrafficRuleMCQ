...
public class sign_inActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleSignInClient = GoogleSignIn.getClient(sign_inActivity.this, googleSignInOptions);
        ...
        if (firebaseUser != null) {
            ...
            startActivity(new Intent(sign_inActivity.this, MainActivity3.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
